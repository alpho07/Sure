...
<script type="text/javascript" src="{{url('js/sly.min.js')}}"></script>
<script>
jQuery(function($) {
  'use strict';
  ...
  $( 'ul.clearfix').empty( );
                       ...
                       for(var i=0; i< data.length;i++) {
                        ...
                        //   var html = '<a target="_blank" href="'+url+data[i].id+'"><div class="card ">'+verified+'<div class="row col-md-3"><div class="card" style="width: 202px; height: 200px;"><img class="card-img-top" src="'+url2+image+'" alt="Image Here" ><div class="card-block"><p class="card-text" title="'+data[i].LR_No+data[i].Town+'">'+text_truncate(data[i].LR_No+data[i].Town,15,"...")+'</p></div></div></div></div></a>';
                          var html2='<li><div class="col-xs-3 scroll"> <div class="card ">'+verified+'<div class="grow"><img  src="'+image+' " width="248" height="200px" /> </div><div class="card-block"><p style="color:black !important; font-size:18px; text-align: left; font-weight:bold;"><u>'+data[i].LR_No+'</u></p><p style="color:black !important; font-size:12px;">'+data[i].Size+'</p><p style="color:black !important; font-size:12px;">'+data[i].Description+'</p><a href="'+url+data[i].id+'" class="btn btn-primary" style="position:absolute;bottom:0px; margin:10px; margin-left:50px; background:#449D44; "><i class="fa fa-eye"></i> View</a></div></div></div></li>';
                ...
                if (flag && no_data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                          ...
                          var html2='<div class="col-xs-3"><div class="card ">'+verified+'<div class="grow"><img  src="'+image+' " width="248" height="200px" /></div><div class="card-block"><p class="" style="color:black !important;"><u>'+data[i].LR_No+'</p><h6 class="card-title">'+data[i].Size+'</h6><p class="card-text">'+data[i].Description+'</p><a href="'+url+data[i].id+'" class="btn btn-primary" style="position:absolute;bottom:0px; margin:10px; margin-left:50px; background:#449D44; "><i class="fa fa-eye"></i> View</a></div></div></div>';
...
<center><main class="ce--main" role="main">
        ...
        <div class="container" id="container-data" style="margin-top:10px !important;">
           <h1 class="card1"> Published Caveats</h1>       
