...
@section('content')
  ...
  <main class="ce--main" role="main">
    ...
    @endif
      ...
      <!--tr>
      <td>
      <strong>Contact person:    </strong> Phyllis Wambugu<br>
    <strong>Email:    </strong> capitaledge@gmail.com<br>
    <strong>Phone:    </strong> 0710 386284
      </td>
      </tr-->
      <tr>
      <td>
...
<input required id="cavid" name="cavid" type="hidden"  value="0">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input id="email" required name="email" type="text" placeholder="Your email" class="form-control">
                                                                </div>
                                                            </div>
