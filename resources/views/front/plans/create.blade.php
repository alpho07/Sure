            ...
            <div class="card-block">
                {!!Form::model($plan, ['action'=>'PlansController@store', 'class'=>'form_horizontal', 'role'=>'form'])!!}
                    <div class="form-group{{ $errors->has('plan_name') ? ' has-error' : '' }} row">
                            ...
                            <div class="col-md-6">
                                <input id="plan_name" type="date" class="form-control" name="plan_name" value="{{ old('plan_name') }}" required>
                    ...
                    <div class="form-group{{ $errors->has('notices') ? ' has-error' : '' }} row">
                            ...
                            <div class="col-md-6">
                                <input id="notices" type="date" class="form-control" name="notices" value="{{ old('notices') }}" required placeholder = "No. of Notices" />
